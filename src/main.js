...
function SetCardType(type) {
  ...
  cclogo.setAttribute("src", logo[type])
}

SetCardType("flamengo")
// securityCode
...
cardHolder.addEventListener("input", () => {
  const ccHolder = document.querySelector(".ccHolder, .value")
  ccHolder.innerHTML =
...
function updateCardNumber(number) {
  ...
  ccNumber.innerHTML = number.length === 0 ? "1234 5678 9101 1121" : number
}
